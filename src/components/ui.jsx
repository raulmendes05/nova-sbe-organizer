...
export function Icon({ name, className = 'w-6 h-6' }) {
  const paths = {
    ...
    camera: <><path d="M3 8a2 2 0 0 1 2-2h2.5l1.2-2h6.6L16.5 6H19a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><circle cx="12" cy="12.5" r="3.5" /></>,
    ...
    upload: <><path d="M12 19V7" /><path d="M7 11l5-5 5 5" /><path d="M4 20h16" /></>,
